...
public class FoodDbContext : DbContext
{
   ...
   protected override void OnModelCreating(ModelBuilder modelBuilder)
   {
      ...
      {
         new Cafeteria { CafeteriaId = 1, CityId = 1, LocationId = locations[0].LocationId, Location = null, Packages = new List<Package>()},
         new Cafeteria { CafeteriaId = 2, CityId = 1, LocationId = locations[1].LocationId, Location = null, Packages = new List<Package>()},
         new Cafeteria { CafeteriaId = 3, CityId = 1, LocationId = locations[2].LocationId, Location = null, Packages = new List<Package>()}
      };
      ...
      var packages = new List<Package>()
      {
         ...
         new Package
         {
            ...
            ReservedByStudentId = students[0].StudentId,
            Products = new List<Product>(),
            City = null, 
         },
      };
